...
img_n45 = (double(img_n45(105:204,170:269,:))-offset)*gain;
img_0 = (double(img_0(105:204,170:269,:))-offset)*gain;
img_90 = (double(img_90(105:204,170:269,:))-offset)*gain;
img_p45 = (double(img_p45(105:204,170:269,:))-offset)*gain;
...
for groupInd = 1:ceil(size(img_n45,3)/parWorker)
    ...
    if groupInd ~= ceil(size(img_n45,3)/parWorker)
...
save('fibrils_NileRed.mat','loc_data');

%% visualize final results
sideL = pxSize*imgSz;
binSz = 80;
visualizeRoSEest(loc_data,sideL,binSz)
